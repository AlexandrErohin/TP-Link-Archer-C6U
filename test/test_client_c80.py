...
from tplinkrouterc6u.common.dataclass import Firmware, Status, Device, IPv4Status, IPv4Reservation, IPv4DHCPLease, VPNStatus
...
class TestTPLinkClient(TestCase):
    ...
    def test_get_ipv4_status(self) -> None:
        ...
        self.assertEqual(ipv4_status._wan_macaddr, EUI48('00-00-00-00-00-01'))
