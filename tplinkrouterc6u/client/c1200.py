...
class TplinkC1200Router(TplinkC5400XRouter):
    ...
    def get_vpn_status(self) -> VPNStatus:
        ...
        values = [
            ...
            self.request("/admin/vpnconn?form=config&operation=list&vpntype=openvpn", "operation=list&operation=list&vpntype=openvpn"),
            self.request("/admin/vpnconn?form=config&operation=list&vpntype=pptp", "operation=list&operation=list&vpntype=pptp"),
        ]
